                            ...
                            for attribute_name, attribute in differences_ab[difference].items():
                                ...
                                if all_attributes[difference]['shape'] == all_attributes[b_object]['shape']:
                                    if attribute_name == 'angle':
                                        ...
                                        if mirrored:
                                            if D_C[c_object]['shape'] == 'triangle': 
                                                new_angle = self.tri_dict[D_C[c_object][attribute_name]]
                                                D_C[c_object][attribute_name] = new_angle
                                            elif D_C[c_object]['shape'] == 'pac-man': 
                                                new_angle = self.pac_dict[D_C[c_object][attribute_name]]
                                                D_C[c_object][attribute_name] = new_angle
                                        else:
                                            ...
                                            new_angle = (int(D_C[c_object][attribute_name]) + delta_angle) % 360
